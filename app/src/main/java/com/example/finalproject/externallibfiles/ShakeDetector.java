package com.example.finalproject.externallibfiles;

//IMPORTANT NOTE: this is not my original code but a library seismic (due to some reasons in couldn't
// be successfully used as a dependency, therefore I just copied a java class here)
//https://github.com/square/seismic - this is the github page of the author of the library
